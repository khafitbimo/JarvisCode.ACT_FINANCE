...
#End Region
    ...
    Public Sub defaultChannel()
        Me.DataFill(dt_default_channel, "act_select_channel_reference_default", "channel_default = 1")
    End Sub
        ...
        If e.RowIndex >= 0 Then
            ...
            Select Case e.ColumnIndex
                ...
                Case Me.DgvTrnJurnaldetil_Credit.Columns("select_received").Index
                    ...
                    'ari prasasti - Trans Tv - 03-July-2012
                    If CType(acc_id, Integer) <> 0 Then
                        ...
                        If acc_id = 111 Then '100 Then
                            Dim dlg As dlgTrnJurnal_PV_List_TransferRekening = New dlgTrnJurnal_PV_List_TransferRekening(Me.DSN, _
                                                ...
                                                Me.DgvTrnJurnaldetil_Credit.Rows(e.RowIndex).Cells("jurnaldetil_line").Value, tbl_TrnContract, Me._CHANNEL, Me.UserName, Me.obj_Rekanan_id.SelectedValue)
                            'Me.tbl_TrnContract
                            Dim retObj As Object
                            Dim retData As Collection
