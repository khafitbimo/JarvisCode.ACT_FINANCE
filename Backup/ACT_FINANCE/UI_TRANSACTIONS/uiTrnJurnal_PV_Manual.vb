...
' TransTV
' Created Date: 10/18/2010 2:13 PM
...
#End Region
    ...
    End Function
    Private Function uiTrnJurnal_PV_Manual_RowCalcIDR(ByVal dgv As DataGridView, ByVal cellIDR As DataGridViewCell, ByVal cellForeign As DataGridViewCell, ByVal cellRate As DataGridViewCell) As Boolean
