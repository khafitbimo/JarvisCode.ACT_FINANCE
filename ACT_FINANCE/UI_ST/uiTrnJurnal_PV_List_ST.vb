...
Public Class uiTrnJurnal_PV_List_ST
    Implements ILocking

    Private Const mUiName As String = "Transaksi Jurnal PV List ST (List Jurnal ST)"
    Private Const SHOW_SAVE_CONFIRMATION As Boolean = True

    Private Const ConstMyJurnalType As String = "PV"
    Private ConstMyJurnalSource As String = clsSource.PVListST
    ...
    Private objPrintHeaderPayment As DataSource.clsRptJurnalST_Header
    Private objPrintDetilPayment As DataSource.clsRptJurnalST_Detil
...
#Region " Window Parameter "
    ...
    Private _USER_TYPE As String = "SPV" '"STAFF" 'SPV 'STAFF
#End Region
...
#Region " Additional Overrides "
    ...
    Private Sub btnPost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPost.Click, btnUnPost.Click
        ...
        If Me.uiTrnJurnal_PV_List_ST_FormError() Then
        ...
        If obj.Name = "btnPost" Then
            ...
            If tbl_TrnJurnal_Changes_Post IsNot Nothing _
                ...
                Me.uiTrnJurnal_PV_List_ST_Save()
    ...
    Private Sub btn_ListAP_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_ListST.Click
        Me.DialogOpen_Reference_List_ST()
    End Sub
...
#Region " Overrides "
    ...
    Public Overrides Function btnNew_Click() As Boolean
        ...
        If Me.ftabMain.SelectedIndex = 0 Then
            ...
            Me.uiTrnJurnal_PV_List_ST_NewData()
    ...
    Public Overrides Function btnLoad_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnJurnal_PV_List_ST_Retrieve()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnPrint_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnJurnal_PV_List_ST_Print()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnPrintPreview_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnJurnal_PV_List_ST_PrintPreview()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnDel_Click() As Boolean
        ...
        ElseIf Me.DgvTrnJurnalResponse.Rows.Count > 0 Then
            ...
            MsgBox(message)
        Else
            Me.uiTrnJurnal_PV_List_ST_Delete()
        End If
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnFirst_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnJurnal_PV_List_ST_First()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnPrev_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnJurnal_PV_List_ST_Prev()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnNext_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnJurnal_PV_List_ST_Next()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnLast_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnJurnal_PV_List_ST_Last()
        Me.Cursor = Cursors.Arrow
...
#Region " Dialoged Control "
    Private Function DialogOpen_Reference_List_ST() As Boolean
        Dim dlg As dlgTrnJurnal_PV_Select_ST = New dlgTrnJurnal_PV_Select_ST(Me.DSN, Me.tbl_MstRekananGrid.Copy, Me.tbl_MstAccGrid.Copy, Me._CHANNEL)
        ...
        If retObj IsNot Nothing Then
            ...
            For k = 0 To tblJDetil.Rows.Count - 1
                ...
                If tblJDetil.Rows(k).Item("acc_id") = 3005020 Or tblJDetil.Rows(k).Item("acc_id") = 3005010 Or tblJDetil.Rows(k).Item("acc_id") = 3005040 Or tblJDetil.Rows(k).Item("acc_id") = 3005060 Then
                    row_kredit = Me.tbl_TrnJurnaldetil_Credit.NewRow
                    ...
                    If tblJDetil.Rows(k).Item("acc_id") = 3005020 Then
                        'G/IR pph21 dilawan Clearing pph21
                        row_kredit.Item("acc_id") = 1950420
                    ElseIf tblJDetil.Rows(k).Item("acc_id") = 3005010 Then
                        'G/IR pph23 dilawan Clearing pph23
                        row_kredit.Item("acc_id") = 1950430
                    ElseIf tblJDetil.Rows(k).Item("acc_id") = 3005040 Then
                        'G/IR pph final dilawan clearing pph final (pph4(2))
                        row_kredit.Item("acc_id") = 1950920
                    ElseIf tblJDetil.Rows(k).Item("acc_id") = 3005060 Then
                        'G/IR pph26
                        row_kredit.Item("acc_id") = 1950910
                    ElseIf tblJDetil.Rows(k).Item("acc_id") = 3005030 Then
                        'G/IR pph15
                        row_kredit.Item("acc_id") = 1950920
                    Else
                    ...
                    Me.tbl_TrnJurnaldetil_Credit.Rows.Add(row_kredit)
                Else
                    If Me.tbl_TrnJurnaldetil_Credit.Rows.Count <= 0 Then
                        ...
                        Me.tbl_TrnJurnaldetil_Credit.Rows.Add(row_kredit)
                    Else
                        For l = 0 To Me.tbl_TrnJurnaldetil_Credit.Rows.Count - 1
                            If Me.tbl_TrnJurnaldetil_Credit.Rows(l).Item("acc_id") <> 1950420 And Me.tbl_TrnJurnaldetil_Credit.Rows(l).Item("acc_id") <> 1950430 And Me.tbl_TrnJurnaldetil_Credit.Rows(l).Item("acc_id") <> 1950920 Then
                                Me.tbl_TrnJurnaldetil_Credit.Rows(l).Item("jurnaldetil_idr") += String.Format("{0:#,##0}", CDec(tblJDetil.Rows(k).Item("jurnaldetil_idr")))
                                Me.tbl_TrnJurnaldetil_Credit.Rows(l).Item("jurnaldetil_foreign") += String.Format("{0:#,##0.00}", CDec(tblJDetil.Rows(k).Item("jurnaldetil_foreign")))
                                is_allPPh = False
                                Exit For
                            End If
                        Next
                        If is_allPPh = True Then
                            row_kredit = Me.tbl_TrnJurnaldetil_Credit.NewRow
                            row_kredit.Item("currency_id") = tblJDetil.Rows(k).Item("currency_id")
                            row_kredit.Item("jurnaldetil_descr") = tblJDetil.Rows(k).Item("jurnaldetil_descr")
                            row_kredit.Item("jurnaldetil_idr") = String.Format("{0:#,##0}", CDec(tblJDetil.Rows(k).Item("jurnaldetil_idr")))
            ...
            Me.uiTrnJurnal_PV_List_ST_RowCalculate(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih, jumlah)
            Me.obj_Selisih.Text = String.Format("{0:#,##0}", selisih)
            Me.obj_Jumlah.Text = String.Format("{0:#,##0}", jumlah)

            Me.uiTrnJurnal_PV_List_ST_RowCalculateForeign(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih, jumlah)
...
#Region " User Defined Function "
    ...
    Private Function uiTrnJurnal_PV_List_ST_NewData() As Boolean
        'new data
    ...
    Private Function uiTrnJurnal_PV_List_ST_Retrieve() As Boolean
        'retrieve data 
    ...
    Private Function uiTrnJurnal_PV_List_ST_Save() As Boolean
        'save data
        Dim tbl_TrnJurnal_Temp_Changes As DataTable
        Dim tbl_TrnJurnaldetil_Debit_Changes As DataTable
        Dim tbl_TrnJurnaldetil_Credit_Changes As DataTable
        ...
        If tbl_TrnJurnal_Temp_Changes IsNot Nothing Or tbl_TrnJurnaldetil_Debit_Changes IsNot Nothing Or tbl_TrnJurnaldetil_Credit_Changes IsNot Nothing Or tbl_TrnJurnalReference_Changes IsNot Nothing Or tbl_TrnBankTransfer_Changes IsNot Nothing Then
            ...
            Try
                ...
                If tbl_TrnJurnal_Temp_Changes IsNot Nothing Then
                    success = Me.uiTrnJurnal_PV_List_ST_SaveMaster(jurnal_id, tbl_TrnJurnal_Temp_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Saving Master Data at Me.uiTrnJurnal_PV_List_ST_SaveMaster(tbl_TrnJurnal_Temp_Changes)")
                    Me.tbl_TrnJurnal_Temp.AcceptChanges()
                End If

                If tbl_TrnJurnalReference_Changes IsNot Nothing Then
                    success = Me.uiTrnJurnal_PV_List_ST_SaveReference(jurnal_id, tbl_TrnJurnalReference_Changes, MasterDataState)
                ...
                If tbl_TrnJurnaldetil_Debit_Changes IsNot Nothing Then
                    For i = 0 To Me.tbl_TrnJurnaldetil_Debit.Rows.Count - 1
                        ...
                        End If
                    Next
                    success = Me.uiTrnJurnal_PV_List_ST_SaveDetilDebit(jurnal_id, tbl_TrnJurnaldetil_Debit_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnJurnal_PV_List_ST_SaveDetil(tbl_TrnJurnaldetil_Debit_Changes)")
                ...
                If tbl_TrnJurnaldetil_Credit_Changes IsNot Nothing Then
                    For i = 0 To Me.tbl_TrnJurnaldetil_Credit.Rows.Count - 1
                        ...
                        End If
                    Next
                    Me.uiTrnJurnal_PV_List_ST_TblDetilInverse(tbl_TrnJurnaldetil_Credit_Changes)
                    success = Me.uiTrnJurnal_PV_List_ST_SaveDetilCredit(jurnal_id, tbl_TrnJurnaldetil_Credit_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnJurnal_PV_List_ST_SaveDetil(tbl_TrnJurnaldetil_Credit_Changes)")
                ...
                If tbl_TrnBankTransfer_Changes IsNot Nothing Then
                    For i = 0 To Me.tbl_TrnBankTransfer.Rows.Count - 1
                        ...
                        End If
                    Next
                    success = Me.uiTrnJurnal_PV_List_ST_SaveTransfer(jurnal_id, tbl_TrnBankTransfer_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnJurnal_PV_List_ST_SaveTransfer(tbl_TrnBankTransfer_Changes)")
    ...
    Private Function uiTrnJurnal_PV_List_ST_SaveMaster(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
    ...
    Private Function uiTrnJurnal_PV_List_ST_SaveDetilDebit(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
    ...
    Private Function uiTrnJurnal_PV_List_ST_SaveDetilCredit(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
    ...
    Private Function uiTrnJurnal_PV_List_ST_SaveReference(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnJurnal_PV_List_ST_SaveTransfer(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnJurnal_PV_List_ST_Delete() As Boolean
        Dim res As String = ""
        Dim jurnal_id As Object = New Object
        ...
        If Me.DgvTrnJurnal.CurrentRow IsNot Nothing Then
            ...
            If res = DialogResult.Yes Then
                Me.uiTrnJurnal_PV_List_ST_DeleteRow(Me.DgvTrnJurnal.CurrentRow.Index)
            End If
    ...
    Private Function uiTrnJurnal_PV_List_ST_DeleteRow(ByVal rowIndex As Integer) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdDelete As OleDb.OleDbCommand
        ...
        Try
            ...
            If Me.DgvTrnJurnal.Rows.Count > 1 Then
                If rowIndex = 0 Then
                    ...
                    Me.uiTrnJurnal_PV_List_ST_OpenRow(NewRowIndex)
                ElseIf rowIndex = Me.DgvTrnJurnal.Rows.Count - 1 Then
                    NewRowIndex = rowIndex - 1
                    Me.uiTrnJurnal_PV_List_ST_OpenRow(NewRowIndex)
                Else
                    Me.uiTrnJurnal_PV_List_ST_OpenRow(rowIndex)
                End If
            Else
                Me.tbl_TrnJurnal_Temp.Clear()
                Me.uiTrnJurnal_PV_List_ST_NewData()
    ...
    Private Function uiTrnJurnal_PV_List_ST_OpenRow(ByVal rowIndex As Integer) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim jurnal_id As String
        ...
        Try
            dbConn.Open()
            clsApplicationRole.SetAppRole(dbConn, cookie)
            Me.uiTrnJurnal_PV_List_ST_OpenRowMaster(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_List_ST_OpenRowDetilDebit(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_List_ST_OpenRowDetilCredit(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_List_ST_OpenRowReference(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_List_ST_OpenRowResponse(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_List_ST_OpenRowTransfer(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_List_ST_OpenRowBankLink(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_List_ST_OpenRowContract(jurnal_id, dbConn)
            ...
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, mUiName & ": uiTrnJurnal_PV_List_ST_OpenRow()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            clsApplicationRole.UnsetAppRole(dbConn, cookie)
            dbConn.Close()
        End Try
    ...
    Private Function uiTrnJurnal_PV_List_ST_OpenRowMaster(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            Me.BindingStart()
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnJurnal_PV_List_ST_OpenRowMaster()" & vbCrLf & ex.Message)
        End Try

    End Function

    Private Function uiTrnJurnal_PV_List_ST_OpenRowDetilDebit(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            Me.DgvTrnJurnaldetil_Debit.DataSource = Me.tbl_TrnJurnaldetil_Debit
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnJurnal_PV_List_ST_OpenRowDetilDebit()" & vbCrLf & ex.Message)
        End Try

    End Function

    Private Function uiTrnJurnal_PV_List_ST_OpenRowDetilCredit(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            Me.uiTrnJurnal_PV_List_ST_TblDetilInverse(Me.tbl_TrnJurnaldetil_Credit)
            Me.DgvTrnJurnaldetil_Credit.DataSource = Me.tbl_TrnJurnaldetil_Credit

        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnJurnal_PV_List_ST_OpenRowDetilCredit()" & vbCrLf & ex.Message)
        End Try

    End Function

    Private Function uiTrnJurnal_PV_List_ST_OpenRowReference(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnJurnal_PV_List_ST_OpenRowResponse(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnJurnal_PV_List_ST_OpenRowTransfer(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnJurnal_PV_List_ST_OpenRowBankLink(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnJurnal_PV_List_ST_OpenRowBankLink()" & vbCrLf & ex.Message)
        End Try

    End Function

    Private Function uiTrnJurnal_PV_List_ST_First() As Boolean
        ...
        If iTab = 1 Then
            If Me.DATA_ISLOCKED Then
                move = True
            Else
                move = Me.uiTrnJurnal_PV_List_ST_ConfirmSaveBeforeMove(Message)
            End If
        Else
            move = True
        End If
        ...
        If move Then
            Try
                ...
                Me.uiTrnJurnal_PV_List_ST_RefreshPosition()
            Catch ex As Exception
            End Try
        End If
    End Function

    Private Function uiTrnJurnal_PV_List_ST_Prev() As Boolean
    ...
    Private Function uiTrnJurnal_PV_List_ST_Next() As Boolean
    ...
    Private Function uiTrnJurnal_PV_List_ST_Last() As Boolean
    ...
    Private Function uiTrnJurnal_PV_List_ST_RefreshPosition() As Boolean
        'refresh position
        Dim iTab As Integer = Me.ftabMain.SelectedIndex
        If iTab = 1 Then uiTrnJurnal_PV_List_ST_OpenRow(Me.DgvTrnJurnal.CurrentRow.Index)
    End Function

    Private Function uiTrnJurnal_PV_List_ST_ConfirmSaveBeforeMove(ByVal Message As String) As Boolean
    ...
    Private Function uiTrnJurnal_PV_List_ST_FormError() As Boolean
        Dim message As String = ""
        Try
            ...
            '        Me.uiTrnJurnal_PV_List_ST_RowCalcIDR(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Debit.Rows(r).Cells("jurnaldetil_idr"), Me.DgvTrnJurnaldetil_Debit.Rows(r).Cells("jurnaldetil_foreign"), Me.DgvTrnJurnaldetil_Debit.Rows(r).Cells("jurnaldetil_foreignrate"))
            '    End If
            'Next
            ...
            '        Me.uiTrnJurnal_PV_List_ST_RowCalcIDR(Me.DgvTrnJurnaldetil_Credit, Me.DgvTrnJurnaldetil_Credit.Rows(r).Cells("jurnaldetil_idr"), Me.DgvTrnJurnaldetil_Credit.Rows(r).Cells("jurnaldetil_foreign"), Me.DgvTrnJurnaldetil_Credit.Rows(r).Cells("jurnaldetil_foreignrate"))
            '    End If
            'Next
            '=========================================================================================
...
#End Region
    ...
    Private Sub uiTrnJurnal_PV_List_ST_FormAfterOpenRow(ByRef id As Object) Handles Me.FormAfterOpenRow
        Dim selisih_idr, jumlah_idr, selisih_foreign, jumlah_foreign As Decimal

        Me.uiTrnJurnal_PV_List_ST_RowCalculate(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih_idr, jumlah_idr)
        Me.uiTrnJurnal_PV_List_ST_RowCalculateForeign(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih_foreign, jumlah_foreign)
        ...
        Me.uiTrnJurnal_PV_List_ST_SetDefaultValueOfJurnaldetil_Debit(Me.obj_Rekanan_id, "rekanan_id")
        Me.tbl_TrnJurnaldetil_Debit.Columns("rekanan_name").DefaultValue = Me.obj_Rekanan_id.Text
        Me.uiTrnJurnal_PV_List_ST_SetDefaultValueOfJurnaldetil_Debit(Me.obj_Currency_id, "currency_id")
        ...
        Me.uiTrnJurnal_PV_List_ST_SetDefaultValueOfJurnaldetil_Credit(Me.obj_Currency_id, "currency_id")
        Me.uiTrnJurnal_PV_List_ST_SetDefaultValueOfJurnaldetil_Credit(Me.obj_Rekanan_id, "rekanan_id")
        ...
        If Me.uiTrnJurnal_PV_List_ST_DataIsLocked() Then
    ...
    Private Sub uiTrnJurnal_PV_List_ST_FormAfterSave(ByRef id As Object, ByVal result As uiBase.FormSaveResult) Handles Me.FormAfterSave
        Dim selisih, jumlah As Decimal
        Me.uiTrnJurnal_PV_List_ST_RowCalculate(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih, jumlah)
        Me.obj_Selisih.Text = String.Format("{0:#,##0}", selisih)
        Me.obj_Jumlah.Text = String.Format("{0:#,##0}", jumlah)
    ...
    Private Sub uiTrnJurnal_PV_List_ST_FormBeforeNew() Handles Me.FormBeforeNew
        Me.tbtnDel.Enabled = False
        locking.Clear()
    End Sub

    Private Sub uiTrnJurnal_PV_List_ST_FormBeforeOpenRow(ByRef id As Object) Handles Me.FormBeforeOpenRow
        DATADETIL_OPENED = False
    End Sub
    ...
    Public Sub Form_Load(ByVal sender As Object)
        ...
        If (Me.Browser IsNot Nothing And MyBase.Name = _Name) Or (Me.Browser Is Nothing And Application.ProductName <> _ProductName) Then
            ...
            Me.uiTrnJurnal_PV_List_ST_isBackgroudWorker()
            Me.uiTrnJurnal_PV_List_ST_LoadComboBox()
    ...
    Private Sub uiTrnJurnal_PV_List_ST_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ftabMain_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ftabMain.SelectedIndexChanged
        Select Case ftabMain.SelectedIndex
            ...
            Case 1
                ...
                Else
                    If Me.DgvTrnJurnal.CurrentRow IsNot Nothing Then
                        Me.uiTrnJurnal_PV_List_ST_OpenRow(Me.DgvTrnJurnal.CurrentRow.Index)
                    Else
                        Me.uiTrnJurnal_PV_List_ST_NewData()
                    End If
                End If
    ...
    Private Sub DgvTrnJurnaldetil_Debit_CellValidated(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnJurnaldetil_Debit.CellValidated
        ...
        If colName = "jurnaldetil_foreign" Or colName = "jurnaldetil_foreignrate" Then
            If obj.Rows(e.RowIndex).Cells("currency_id").Value = 1 Then
                Me.uiTrnJurnal_PV_List_ST_RowCalculateForeignIDR(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih, jumlah)
            ...
            If obj.Rows(e.RowIndex).Cells("acc_id").Value <> akun8500015 And _
              (obj.Rows(e.RowIndex).Cells("acc_id").Value <> akun8509990 And obj.Rows(e.RowIndex).Cells("jurnaldetil_foreign").Value <> 0 And obj.Rows(e.RowIndex).Cells("jurnaldetil_foreignrate").Value <> 0) Then
                Me.uiTrnJurnal_PV_List_ST_RowCalcIDR(obj, obj.Rows(e.RowIndex).Cells("jurnaldetil_idr"), obj.Rows(e.RowIndex).Cells("jurnaldetil_foreign"), obj.Rows(e.RowIndex).Cells("jurnaldetil_foreignrate"))
            End If
        End If
...
#Region " Print "
    Private Function uiTrnJurnal_PV_List_ST_Print() As Boolean
        Dim retObj As Object
        Dim i, j As Integer
    ...
    Private Function GenerateDataHeaderPayment(ByVal jurnal_id_temp As String, ByVal channel_id_temp As String) As ArrayList
        ...
        Me.objPrintHeaderPayment = New DataSource.clsRptJurnalST_Header(Me.DSN)
        Me.tbl_Print.Clear()
    ...
    Private Function GenerateDataDetailPayment() As ArrayList
        ...
        foreignAmount = 0
        For i = 0 To Me.tbl_PrintDetil.Rows.Count - 1
            Me.objPrintDetilPayment = New DataSource.clsRptJurnalST_Detil(Me.DSN)
    ...
    End Sub
    Private Function uiTrnJurnal_PV_List_ST_PrintPreview() As Boolean
        Dim retObj As Object
...
#Region " Untuk BackgroundWorker"
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        If BG_Worker.CancellationPending Then
            e.Cancel = True
        Else
            Me.uiTrnJurnal_PV_List_ST_CollectionData_with_BackgroundWorker(BG_Worker)
        End If
    ...
    Public Sub uiTrnJurnal_PV_List_ST_newBackgroundWorker()
        Me.BackgroundWorker1 = New BackgroundWorker
        BackgroundWorker1.RunWorkerAsync()
    End Sub

    Private Sub uiTrnJurnal_PV_List_ST_CollectionData_with_BackgroundWorker(ByVal worker As BackgroundWorker)
        ...
        '3201	7102120	Biaya Lain-lain - Kerugian - Selisih Kurs Pajak
        '3202	7202120	(Keuntungan) Lain-lain - Selisih Kurs Pajak
        '3301	7201210	(Pendapatan) Lain-lain - Lain-lain
        '3302	7101210	Biaya Lain-lain - Biaya - Adm
        '3101	7102110	Biaya Lain-lain - Kerugian - Selisih Kurs
        '3102	7202110	(Keuntungan) Lain-lain - Selisih Kurs
    ...
    Private Sub uiTrnJurnal_PV_List_ST_isBackgroudWorker()
        ...
        If Me.isBackGroundWorker_isWork = False Then
            ...
            If Me.isBackgroundWorker = False Then
                ...
                If Me.BackgroundWorker1.IsBusy Then
                    ...
                    Me.uiTrnJurnal_PV_List_ST_newBackgroundWorker()
                Else
    ...
    Private Sub uiTrnJurnal_PV_List_ST_LoadComboBox()
...
#End Region
    ...
    Private Function uiTrnJurnal_PV_List_ST_RowCalculate(ByVal dgv_D As DataGridView, ByVal dgv_K As DataGridView, ByRef selisih As Decimal, ByRef jumlah As Decimal) As Boolean
        Dim i As Integer
    ...
    Private Function uiTrnJurnal_PV_List_ST_RowCalculateForeign(ByVal dgv_D As DataGridView, ByVal dgv_K As DataGridView, ByRef selisih As Decimal, ByRef jumlah As Decimal) As Boolean
        Dim i As Integer
        Dim value As Decimal
    ...
    Private Function uiTrnJurnal_PV_List_ST_RowCalculateForeignIDR(ByVal dgv_D As DataGridView, ByVal dgv_K As DataGridView, ByRef selisih As Decimal, ByRef jumlah As Decimal) As Boolean
        Dim i As Integer
        Dim value As Decimal
        Dim cellForeign As DataGridViewCell
        Dim dgv As DataGridView
    ...
    Private Function uiTrnJurnal_PV_List_ST_RowCalcIDR(ByVal dgv As DataGridView, ByVal cellIDR As DataGridViewCell, ByVal cellForeign As DataGridViewCell, ByVal cellRate As DataGridViewCell) As Boolean
    ...
    Private Function uiTrnJurnal_PV_List_ST_TblDetilInverse(ByVal tbl As DataTable) As Boolean
        Dim i As Integer
    ...
    Private Function uiTrnJurnal_PV_List_ST_SetDefaultValueOfJurnaldetil_Debit(ByVal sender As System.Object, ByVal columnname As String) As Boolean
        Dim id As String
    ...
    Private Function uiTrnJurnal_PV_List_ST_SetDefaultValueOfJurnaldetil_Credit(ByVal sender As System.Object, ByVal columnname As String) As Boolean
        Dim id As String
        Dim cbo As ComboBox = sender
        Try
            If cbo.SelectedValue IsNot Nothing Then
    ...
    Private Function uiTrnJurnal_PV_List_ST_DataIsLocked() As Boolean
    ...
    Private Sub obj_Rekanan_id_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles obj_Rekanan_id.Validated
        ...
        Me.uiTrnJurnal_PV_List_ST_SetDefaultValueOfJurnaldetil_Debit(sender, cbo.ValueMember)
        Me.uiTrnJurnal_PV_List_ST_SetDefaultValueOfJurnaldetil_Credit(sender, cbo.ValueMember)
    ...
    Private Function cek_reval_BeforePosting() As Boolean
        Try
            ...
            Dim cekAP As String = jurnal.Substring(0, 2)
            Dim rate As Decimal = Me.tbl_TrnJurnaldetil_Debit.Rows(0).Item("jurnaldetil_foreignrate")
    ...
    '========================ADD PTS 20130711==================
    Private Function uiTrnJurnal_PV_List_ST_OpenRowContract(ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnJurnal_PV_List_ST_OpenRowContract()" & vbCrLf & ex.Message)
        End Try
    ...
    Private Sub ChangeAmountIDRTaxToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ChangeAmountIDRTaxToolStripMenuItem.Click
        ...
        If nilaiIDR <> "" Then
            ...
            If IsNumeric(nilaiIDR) = True Then
                ...
                End If
                Me.uiTrnJurnal_PV_List_ST_RowCalculate(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih_idr, jumlah_idr)
                Me.uiTrnJurnal_PV_List_ST_RowCalculate(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih_foreign, jumlah_foreign)
