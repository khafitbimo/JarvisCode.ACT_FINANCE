        ...
        Else
            ...
            Else
                ...
                Try
                    ...
                    xlWorksheet.Cells(1, 2).Value = "Bilyet"
                    xlWorksheet.Cells(1, 3).Value = "Rekanan"
                    xlWorksheet.Cells(1, 4).Value = "Description"
                    xlWorksheet.Cells(1, 5).Value = "Amount"
                    ...
                    For Each row As System.Data.DataRow In Me.tbl_TrnCirculationvoucherdetil.Rows
                        ...
                        If Mid(row.Item("circulationdetil_bilyet").ToString, 1, 1) = "=" Then xlWorksheet.Cells(RowIndex + 1, 2).Value = "'" & row.Item("circulationdetil_bilyet").ToString Else xlWorksheet.Cells(RowIndex + 1, 2).Value = row.Item("circulationdetil_bilyet").ToString
                        If Mid(row.Item("rekanan_name").ToString, 1, 1) = "=" Then xlWorksheet.Cells(RowIndex + 1, 3).Value = "'" & row.Item("rekanan_name").ToString Else xlWorksheet.Cells(RowIndex + 1, 3).Value = row.Item("rekanan_name").ToString
                        If Mid(row.Item("circulationdetil_descr").ToString, 1, 1) = "=" Then xlWorksheet.Cells(RowIndex + 1, 4).Value = "'" & row.Item("circulationdetil_descr").ToString Else xlWorksheet.Cells(RowIndex + 1, 4).Value = row.Item("circulationdetil_descr").ToString
                        If row.Item("currency_id") = 1 Then
                            If Mid(row.Item("circulationdetil_amount").ToString, 1, 1) = "=" Then xlWorksheet.Cells(RowIndex + 1, 5).Value = "'" & row.Item("circulationdetil_amount") Else xlWorksheet.Cells(RowIndex + 1, 5).Value = row.Item("circulationdetil_amount")
                        Else
                            If Mid(row.Item("circulationdetil_foreign").ToString, 1, 1) = "=" Then xlWorksheet.Cells(RowIndex + 1, 5).Value = "'" & row.Item("circulationdetil_foreign") Else xlWorksheet.Cells(RowIndex + 1, 6).Value = row.Item("circulationdetil_foreign")
                        End If
...
#End Region
    Private Sub uiTrnCirculationVoucher_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Me.Browser IsNot Nothing Then
            ...
            Me._CHANNEL = "TTV" 'Me.GetValueFromParameter(objParameters, "CHANNEL")
