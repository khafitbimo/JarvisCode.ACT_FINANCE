Public Class uiRptBankReport
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            command.Parameters.Add("@start_date", OleDb.OleDbType.DBTimeStamp, 4).Value = Me.dtStartDate.Value
            command.Parameters.Add("@end_date", OleDb.OleDbType.DBTimeStamp, 4).Value = Me.dtEndDate.Value
