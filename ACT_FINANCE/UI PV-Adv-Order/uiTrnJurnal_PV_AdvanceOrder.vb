...
'TANDAIN YA KENCINGIN JUGA
Imports Microsoft.Win32
Imports System.Threading
Imports System.ComponentModel
Public Class uiTrnJurnal_PV_AdvanceOrder
    Implements ILocking
    ...
    Private ConstMyJurnalSource As String = clsSource.PVListOrder
...
#Region " Dialoged Control "
    ...
    'Private Function DialogOpen_Reference_AdvanceOrder() As Boolean
    '    Dim dlg As dlgTrnJurnal_PV_Select_AdvanceOrder = New dlgTrnJurnal_PV_Select_AdvanceOrder(Me.DSN, Me.tbl_MstRekananGrid.Copy)
    ...
    Private Function DialogOpen_Reference_Advance() As Boolean
        ...
        If retObj IsNot Nothing Then
            ...
            For k = 0 To tblJDetil.Rows.Count - 1
                ...
                'amountIDR_total += String.Format("{0:#,##0.00}", Math.Round(CDec(tblJDetil.Rows(k).Item("jurnaldetil_idr")), 2, MidpointRounding.AwayFromZero) _
                '                                                 + Math.Round(CDec(tblJDetil.Rows(k).Item("ppn_idr")), 2, MidpointRounding.AwayFromZero) _
                '                                                 - Math.Round(CDec(tblJDetil.Rows(k).Item("pph_idr")), 2, MidpointRounding.AwayFromZero))
                ...
                row.Item("branch_id") = clsUtil.IsDbNull(tblJDetil.Rows(k).Item("branch_id"), 0)
                row.Item("strukturunit_id") = clsUtil.IsDbNull(tblJDetil.Rows(k).Item("strukturunit_id"), 0)
                row.Item("rekanan_id") = 0 ' tblJDetil.Rows(k).Item("rekanan_id") '==========" REKANAN DI DI Debit UM dikosongkan" ======20140922===============
    ...
    '======================ADD PTS 20140923===============================
    'Private Function uiTrnJurnal_PV_Advance_RowCalculatePTS(ByVal dgv_D As DataTable, ByVal dgv_K As DataTable, ByRef selisih As Decimal, ByRef jumlah As Decimal) As Boolean
    '    Dim i As Integer
    '    Dim value As Decimal
    '    Dim cellIDR As String 'DataGridViewCell
    '    Dim dgv As DataTable
    ...
    '        cellIDR = dgv.Rows(i).Item("jurnaldetil_idr")
    '        If cellIDR Is Not Nothing Then
                ...
                If cell_ref_id.Value IsNot DBNull.Value And cell_ref_line.Value IsNot DBNull.Value Then
                    If cell_ref_id.Value <> String.Empty And cell_ref_line.Value <> 0 And cell_accid.Value <> "1162431" Then '1162431 = Clearing - PPN In
                        ...
                        Try
                            ...
                            command = New OleDb.OleDbCommand("act_TrnJurnaldetil_PV_Select_VQListOrderErr", dbconn)
