...
Public Class uiTrnJurnal_PV_Manual
    Implements ILocking

    Private Const mUiName As String = "Transaksi Jurnal PV Manual"
    Private Const SHOW_SAVE_CONFIRMATION As Boolean = True

    Private Const ConstMyJurnalType As String = "PV"
    Private ConstMyJurnalSource As String = clsSource.PVManual
    ...
    Private accref1 As String
    Private accref2 As String
    Private accref3 As String
    Private accref4 As String
    Private accref5 As String
    Private accref6 As String
    Private accref7 As String
    Private accref8 As String
...
#Region " Additional Overrides "
    ...
    Private Sub btnPost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPost.Click, btnUnPost.Click
        ...
        If Me.uiTrnJurnal_PV_Manual_FormError() Then
    ...
    '            If rate_dasar - tax_rate < 0 Then
    '                'kalo turun taro di kredit
    '                'kelebihannya (posisi Debit) pake account yg dibawah ini yah 8500011:
    ...
    '                row.Item("jurnaldetil_idr") = Math.Round(Me.DgvTrnJurnaldetil_Credit.CurrentRow.Cells("jurnaldetil_foreign").Value * (tax_rate - rate_dasar), 0, MidpointRounding.AwayFromZero)
    '                row.Item("jurnaldetil_foreign") = 0
    '                row.Item("jurnaldetil_foreignrate") = Math.Round((tax_rate - rate_dasar), 2, MidpointRounding.AwayFromZero)
    ...
    '                Me.DgvTrnJurnaldetil_Credit.CurrentRow.Cells("jurnaldetil_idr").Value = Math.Round(CDec(Me.DgvTrnJurnaldetil_Credit.CurrentRow.Cells("jurnaldetil_foreign").Value * tax_rate), 0, MidpointRounding.AwayFromZero)

    '            Else
    '                'kalo naik taro di debet
    '                'untuk posisi kekurangan kurs pajak (posisi Credit) pake yang ini 8001000:
    '                row = Me.tbl_TrnJurnaldetil_Credit.NewRow
    '                row.Item("currency_id") = Me.DgvTrnJurnaldetil_Credit.CurrentRow.Cells("currency_id").Value
    '                row.Item("jurnaldetil_descr") = Me.DgvTrnJurnaldetil_Credit.CurrentRow.Cells("jurnaldetil_descr").Value
    '                row.Item("jurnaldetil_idr") = Math.Round(Me.DgvTrnJurnaldetil_Credit.CurrentRow.Cells("jurnaldetil_foreign").Value * (rate_dasar - tax_rate), 0, MidpointRounding.AwayFromZero)
    '                row.Item("jurnaldetil_foreign") = 0
    '                row.Item("jurnaldetil_foreignrate") = Math.Round(CDec(rate_dasar - tax_rate), 2, MidpointRounding.AwayFromZero)
    ...
    '            End If
    '            Me.uiTrnJurnal_PV_Manual_RowCalculate(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih_idr, jumlah_idr)
    '            Me.uiTrnJurnal_PV_Manual_RowCalculateForeign(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih_foreign, jumlah_foreign)
    ...
    'Private Sub btn_changeRateContract_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_changeRateContract.Click
    '    Dim contract_rate As String
    '    Dim row As DataRow
    '    Dim selisih_idr, jumlah_idr, selisih_foreign, jumlah_foreign As Decimal

    '    contract_rate = InputBox("Rate : ", "Contract Rate", "", 100, 100)

    '    If contract_rate <> "" Then
    '        If IsNumeric(contract_rate) = True Then
    '            Dim rate_dasar As Decimal = Me.DgvTrnJurnaldetil_Debit.CurrentRow.Cells("jurnaldetil_foreignrate").Value

    '            If rate_dasar - contract_rate > 0 Then
    '                'kalo turun taro di Debit
    '                'kelebihannya (posisi Debit) pake account yg dibawah ini yah 8500011:
    '                row = Me.tbl_TrnJurnaldetil_Debit.NewRow
    ...
    '                row.Item("jurnaldetil_idr") = Math.Round(Me.DgvTrnJurnaldetil_Debit.CurrentRow.Cells("jurnaldetil_foreign").Value * (rate_dasar - contract_rate), 0, MidpointRounding.AwayFromZero)
    '                row.Item("jurnaldetil_foreign") = 0
    '                row.Item("jurnaldetil_foreignrate") = Math.Round(CDec(rate_dasar - contract_rate), 2, MidpointRounding.AwayFromZero)
    ...
    '                Me.DgvTrnJurnaldetil_Debit.CurrentRow.Cells("jurnaldetil_foreignrate").Value = Math.Round(CDec(contract_rate), 2, MidpointRounding.AwayFromZero)
    '                Me.DgvTrnJurnaldetil_Debit.CurrentRow.Cells("jurnaldetil_idr").Value = Math.Round(CDec(Me.DgvTrnJurnaldetil_Debit.CurrentRow.Cells("jurnaldetil_foreign").Value * contract_rate), 0, MidpointRounding.AwayFromZero)
    '            Else
    '                'kalo naik taro di Credit
    '                'untuk posisi kekurangan kurs pajak (posisi Credit) pake yang ini 8001000:
    '                row = Me.tbl_TrnJurnaldetil_Credit.NewRow
    '                row.Item("currency_id") = Me.DgvTrnJurnaldetil_Debit.CurrentRow.Cells("currency_id").Value
    '                row.Item("jurnaldetil_descr") = Me.DgvTrnJurnaldetil_Debit.CurrentRow.Cells("jurnaldetil_descr").Value
    '                row.Item("jurnaldetil_idr") = Math.Round(Me.DgvTrnJurnaldetil_Debit.CurrentRow.Cells("jurnaldetil_foreign").Value * (contract_rate - rate_dasar), 0, MidpointRounding.AwayFromZero)
    '                row.Item("jurnaldetil_foreign") = 0
    '                row.Item("jurnaldetil_foreignrate") = Math.Round(CDec(contract_rate - rate_dasar), 2, MidpointRounding.AwayFromZero)
...
#Region " Overrides "
    ...
    Public Overrides Function btnNew_Click() As Boolean
        ...
        If Me.ftabMain.SelectedIndex = 0 Then
            ...
            Me.uiTrnJurnal_PV_Manual_NewData()
    ...
    Public Overrides Function btnLoad_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnJurnal_PV_Manual_Retrieve()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnPrint_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnJurnal_PV_Manual_Print()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnPrintPreview_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnJurnal_PV_Manual_PrintPreview()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnDel_Click() As Boolean
        ...
        ElseIf Me.DgvTrnJurnalResponse.Rows.Count > 0 Then
            ...
            MsgBox(message)
        Else
            Me.uiTrnJurnal_PV_Manual_Delete()
        End If
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnFirst_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnJurnal_PV_Manual_First()
        Me.Cursor = Cursors.Arrow
...
#Region " User Defined Function "
    ...
    Private Function uiTrnJurnal_PV_Manual_NewData() As Boolean
        'new data
    ...
    Private Function uiTrnJurnal_PV_Manual_Retrieve() As Boolean
        'retrieve data 
    ...
    Private Function uiTrnJurnal_PV_Manual_Save() As Boolean
        'save data
        Dim tbl_TrnJurnal_Temp_Changes As DataTable
        Dim tbl_TrnJurnaldetil_Debit_Changes As DataTable
        Dim tbl_TrnJurnaldetil_Credit_Changes As DataTable
        ...
        If tbl_TrnJurnal_Temp_Changes IsNot Nothing Or tbl_TrnJurnaldetil_Debit_Changes IsNot Nothing Or tbl_TrnJurnaldetil_Credit_Changes IsNot Nothing Or tbl_TrnBankTransfer_Changes IsNot Nothing Then
            Try                
                ...
                If tbl_TrnJurnal_Temp_Changes IsNot Nothing Then
                    ...
                    Dim dr() As DataRow = Me.tbl_MstPeriode.Select(String.Format("periode_id='{0}'", tbl_TrnJurnal_Temp_Changes.Rows(0).Item("periode_id").ToString))
                    Dim tgl_start As Date = dr(0).Item("periode_datestart")
                    Dim tgl_end As Date = dr(0).Item("periode_dateend")
                    Dim tgl As Date = CDate(tbl_TrnJurnal_Temp_Changes.Rows(0).Item("jurnal_bookdate").ToString).Date
                    ...
                    Else
                        Throw New Exception("Bookdate does not match with the Period!!")
                    End If

                    success = Me.uiTrnJurnal_PV_Manual_SaveMaster(jurnal_id, tbl_TrnJurnal_Temp_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Saving Master Data at Me.uiTrnJurnal_PV_Manual_SaveMaster(tbl_TrnJurnal_Temp_Changes)")
                ...
                If tbl_TrnJurnaldetil_Debit_Changes IsNot Nothing Then
                    For i = 0 To Me.tbl_TrnJurnaldetil_Debit.Rows.Count - 1
                        ...
                        End If
                    Next
                    success = Me.uiTrnJurnal_PV_Manual_SaveDetilDebit(jurnal_id, tbl_TrnJurnaldetil_Debit_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnJurnal_PV_Manual_SaveDetil(tbl_TrnJurnaldetil_Debit_Changes)")
                ...
                If tbl_TrnJurnaldetil_Credit_Changes IsNot Nothing Then
                    For i = 0 To Me.tbl_TrnJurnaldetil_Credit.Rows.Count - 1
                        ...
                        End If
                    Next
                    Me.uiTrnJurnal_PV_Manual_TblDetilInverse(tbl_TrnJurnaldetil_Credit_Changes)
                    success = Me.uiTrnJurnal_PV_Manual_SaveDetilCredit(jurnal_id, tbl_TrnJurnaldetil_Credit_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnJurnal_PV_Manual_SaveDetil(tbl_TrnJurnaldetil_Credit_Changes)")
                ...
                If tbl_TrnBankTransfer_Changes IsNot Nothing Then
                    For i = 0 To Me.tbl_TrnBankTransfer.Rows.Count - 1
                        ...
                        End If
                    Next
                    success = Me.uiTrnJurnal_PV_Manual_SaveTransfer(jurnal_id, tbl_TrnBankTransfer_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnJurnal_PV_Manual_SaveTransfer(tbl_TrnBankTransfer_Changes)")
    ...
    Private Function uiTrnJurnal_PV_Manual_SaveMaster(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
    ...
    Private Function uiTrnJurnal_PV_Manual_SaveDetilDebit(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
    ...
    Private Function uiTrnJurnal_PV_Manual_SaveDetilCredit(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
    ...
    Private Function uiTrnJurnal_PV_Manual_SaveTransfer(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
    ...
    Private Function uiTrnJurnal_PV_Manual_Delete() As Boolean
        Dim res As String = ""
        Dim jurnal_id As Object = New Object
        ...
        If Me.DgvTrnJurnal.CurrentRow IsNot Nothing Then
            ...
            If res = DialogResult.Yes Then
                Me.uiTrnJurnal_PV_Manual_DeleteRow(Me.DgvTrnJurnal.CurrentRow.Index)
            End If
    ...
    Private Function uiTrnJurnal_PV_Manual_DeleteRow(ByVal rowIndex As Integer) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdDelete As OleDb.OleDbCommand
        ...
        Try
            ...
            If Me.DgvTrnJurnal.Rows.Count > 1 Then
                If rowIndex = 0 Then
                    ...
                    Me.uiTrnJurnal_PV_Manual_OpenRow(NewRowIndex)
                ElseIf rowIndex = Me.DgvTrnJurnal.Rows.Count - 1 Then
                    NewRowIndex = rowIndex - 1
                    Me.uiTrnJurnal_PV_Manual_OpenRow(NewRowIndex)
                Else
                    Me.uiTrnJurnal_PV_Manual_OpenRow(rowIndex)
                End If
            Else
                Me.tbl_TrnJurnal_Temp.Clear()
                Me.uiTrnJurnal_PV_Manual_NewData()
    ...
    Private Function uiTrnJurnal_PV_Manual_OpenRow(ByVal rowIndex As Integer) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim jurnal_id As String
        ...
        Try
            dbConn.Open()
            clsApplicationRole.SetAppRole(dbConn, cookie)
            Me.uiTrnJurnal_PV_Manual_OpenRowMaster(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_Manual_OpenRowDetilDebit(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_Manual_OpenRowDetilCredit(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_Manual_OpenRowResponse(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_Manual_OpenRowTransfer(channel_id, jurnal_id, dbConn)
            Me.uiTrnJurnal_PV_Manual_OpenRowBankLink(channel_id, jurnal_id, dbConn)
            '====ADD PTS 20130711====
            Me.uiTrnJurnal_PV_Manual_OpenRowContract(jurnal_id, dbConn)
            '========================
            ...
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, mUiName & ": uiTrnJurnal_PV_Manual_OpenRow()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            clsApplicationRole.UnsetAppRole(dbConn, cookie)
            dbConn.Close()
        End Try
    ...
    Private Function uiTrnJurnal_PV_Manual_OpenRowMaster(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            Me.BindingStart()
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnJurnal_PV_Manual_OpenRowMaster()" & vbCrLf & ex.Message)
        End Try

    End Function

    Private Function uiTrnJurnal_PV_Manual_OpenRowDetilDebit(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            Me.DgvTrnJurnaldetil_Debit.DataSource = Me.tbl_TrnJurnaldetil_Debit
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnJurnal_PV_Manual_OpenRowDetilDebit()" & vbCrLf & ex.Message)
        End Try

    End Function

    Private Function uiTrnJurnal_PV_Manual_OpenRowDetilCredit(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            Me.uiTrnJurnal_PV_Manual_TblDetilInverse(Me.tbl_TrnJurnaldetil_Credit)
            Me.DgvTrnJurnaldetil_Credit.DataSource = Me.tbl_TrnJurnaldetil_Credit

        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnJurnal_PV_Manual_OpenRowDetilCredit()" & vbCrLf & ex.Message)
        End Try

    End Function

    Private Function uiTrnJurnal_PV_Manual_OpenRowResponse(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnJurnal_PV_Manual_OpenRowTransfer(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnJurnal_PV_Manual_OpenRowBankLink(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnJurnal_PV_Manual_First() As Boolean
        ...
        If iTab = 1 Then
            If Me.DATA_ISLOCKED Then
                move = True
            Else
                move = Me.uiTrnJurnal_PV_Manual_ConfirmSaveBeforeMove(Message)
            End If
        Else
            move = True
        End If
        ...
        If move Then
            Try
                ...
                Me.uiTrnJurnal_PV_Manual_RefreshPosition()
            Catch ex As Exception
            End Try
        End If
    End Function

    Private Function uiTrnJurnal_PV_Manual_Prev() As Boolean
    ...
    Private Function uiTrnJurnal_PV_Manual_Next() As Boolean
    ...
    Private Function uiTrnJurnal_PV_Manual_Last() As Boolean
    ...
    Private Function uiTrnJurnal_PV_Manual_RefreshPosition() As Boolean
        'refresh position
        Dim iTab As Integer = Me.ftabMain.SelectedIndex
        If iTab = 1 Then uiTrnJurnal_PV_Manual_OpenRow(Me.DgvTrnJurnal.CurrentRow.Index)
    End Function

    Private Function uiTrnJurnal_PV_Manual_ConfirmSaveBeforeMove(ByVal Message As String) As Boolean
    ...
    Private Function uiTrnJurnal_PV_Manual_FormError() As Boolean
        Dim message As String = ""
        Try
            ...
            '        Me.uiTrnJurnal_PV_Manual_RowCalcIDR(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Debit.Rows(r).Cells("jurnaldetil_idr"), Me.DgvTrnJurnaldetil_Debit.Rows(r).Cells("jurnaldetil_foreign"), Me.DgvTrnJurnaldetil_Debit.Rows(r).Cells("jurnaldetil_foreignrate"))
            '    End If
            'Next
            ...
            '        Me.uiTrnJurnal_PV_Manual_RowCalcIDR(Me.DgvTrnJurnaldetil_Credit, Me.DgvTrnJurnaldetil_Credit.Rows(r).Cells("jurnaldetil_idr"), Me.DgvTrnJurnaldetil_Credit.Rows(r).Cells("jurnaldetil_foreign"), Me.DgvTrnJurnaldetil_Credit.Rows(r).Cells("jurnaldetil_foreignrate"))
            '    End If
            'Next
            '=========================================================================================
            ...
            Me.DgvTrnJurnaldetil_Debit.EndEdit()
            Me.DgvTrnJurnaldetil_Credit.EndEdit()
            Me.uiTrnJurnal_PV_Manual_RowCalculate(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih, jumlah)
            If selisih <> 0 Then
            ...
            Me.DgvTrnJurnaldetil_Debit.EndEdit()
            Me.DgvTrnJurnaldetil_Credit.EndEdit()
            Me.uiTrnJurnal_PV_Manual_RowCalculateForeign(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih, jumlah)
            If selisih <> 0 Then
...
#End Region
    ...
    Private Sub uiTrnJurnal_PV_Manual_FormAfterOpenRow(ByRef id As Object) Handles Me.FormAfterOpenRow
        Dim selisih_idr, jumlah_idr, selisih_foreign, jumlah_foreign As Decimal
        ...
        Me.uiTrnJurnal_PV_Manual_SetDefaultValueOfJurnaldetil_Debit(Me.obj_Rekanan_id, "rekanan_id")
        Me.tbl_TrnJurnaldetil_Debit.Columns("rekanan_name").DefaultValue = Me.obj_Rekanan_id.Text
        Me.uiTrnJurnal_PV_Manual_SetDefaultValueOfJurnaldetil_Debit(Me.obj_Currency_id, "currency_id")
        ...
        Me.uiTrnJurnal_PV_Manual_SetDefaultValueOfJurnaldetil_Credit(Me.obj_Currency_id, "currency_id")
        Me.uiTrnJurnal_PV_Manual_SetDefaultValueOfJurnaldetil_Credit(Me.obj_Rekanan_id, "rekanan_id")
        ...
        If Me.uiTrnJurnal_PV_Manual_DataIsLocked() Then
    ...
    Private Sub uiTrnJurnal_PV_Manual_FormAfterSave(ByRef id As Object, ByVal result As uiBase.FormSaveResult) Handles Me.FormAfterSave
        Dim selisih, jumlah As Decimal
        Me.uiTrnJurnal_PV_Manual_RowCalculate(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih, jumlah)
        Me.obj_Selisih.Text = String.Format("{0:#,##0}", selisih)
        Me.obj_Jumlah.Text = String.Format("{0:#,##0}", jumlah)
    ...
    Private Sub uiTrnJurnal_PV_Manual_FormBeforeNew() Handles Me.FormBeforeNew
        Me.tbtnDel.Enabled = False
        Me.btnUpload.Enabled = True
        locking.Clear()
    End Sub

    Private Sub uiTrnJurnal_PV_Manual_FormBeforeOpenRow(ByRef id As Object) Handles Me.FormBeforeOpenRow
        DATADETIL_OPENED = False
    End Sub
    ...
    Public Sub Form_Load(ByVal sender As Object)
        ...
        If (Me.Browser IsNot Nothing And MyBase.Name = _Name) Or (Me.Browser Is Nothing And Application.ProductName <> _ProductName) Then
            ...
            Me.uiTrnJurnal_PV_Manual_isBackgroudWorker()
            Me.uiTrnJurnal_PV_Manual_LoadComboBox()
    ...
    Private Sub uiTrnJurnal_PV_Manual_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ftabMain_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ftabMain.SelectedIndexChanged
        Select Case ftabMain.SelectedIndex
            ...
            Case 1
                ...
                Else
                    If Me.DgvTrnJurnal.CurrentRow IsNot Nothing Then
                        Me.uiTrnJurnal_PV_Manual_OpenRow(Me.DgvTrnJurnal.CurrentRow.Index)
                    Else
                        Me.uiTrnJurnal_PV_Manual_NewData()
                    End If
                End If
...
#Region "Event On Dgv Debit"
    ...
    Private Sub DgvTrnJurnaldetil_Debit_CellValidated(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnJurnaldetil_Debit.CellValidated
        ...
        If colName = "jurnaldetil_foreign" Or colName = "jurnaldetil_foreignrate" Then
            ...
            If obj.Rows(e.RowIndex).Cells("acc_id").Value <> akun8500015 And _
              (obj.Rows(e.RowIndex).Cells("acc_id").Value <> akun8509990 And obj.Rows(e.RowIndex).Cells("jurnaldetil_foreign").Value <> 0 And obj.Rows(e.RowIndex).Cells("jurnaldetil_foreignrate").Value <> 0) Then
                Me.uiTrnJurnal_PV_Manual_RowCalcIDR(obj.Rows(e.RowIndex).Cells("branch_id"), obj.Rows(e.RowIndex).Cells("acc_id"), obj.Rows(e.RowIndex).Cells("jurnaldetil_idr"), obj.Rows(e.RowIndex).Cells("jurnaldetil_foreign"), obj.Rows(e.RowIndex).Cells("jurnaldetil_foreignrate"))
            End If
        End If
        ...
        'If colName = "jurnaldetil_foreign" Or colName = "jurnaldetil_foreignrate" Then
        '    If obj.Rows(e.RowIndex).Cells("currency_id").Value = 1 Then
        '        Me.uiTrnJurnal_PV_Manual_RowCalculateForeignIDR(Me.DgvTrnJurnaldetil_Debit, Me.DgvTrnJurnaldetil_Credit, selisih, jumlah)
        '        If colName = "jurnaldetil_foreign" Then
        '            obj.Rows(e.RowIndex).Cells("jurnaldetil_foreign").Value = Math.Round(obj.Rows(e.RowIndex).Cells("jurnaldetil_foreign").Value, 0, MidpointRounding.AwayFromZero)
        '        End If
        '    Else
        ...
        '    If obj.Rows(e.RowIndex).Cells("acc_id").Value <> akun8500015 And obj.Rows(e.RowIndex).Cells("acc_id").Value <> 8500011 Then
        '        Me.uiTrnJurnal_PV_Manual_RowCalcIDR(obj, obj.Rows(e.RowIndex).Cells("jurnaldetil_idr"), obj.Rows(e.RowIndex).Cells("jurnaldetil_foreign"), obj.Rows(e.RowIndex).Cells("jurnaldetil_foreignrate"))
        '    End If
        'End If
        ...
        If obj.Columns(e.ColumnIndex).Name = "acc_id" Then
            ...
            If Me.tbl_TrnJurnal_Temp.Rows.Count > 0 Then
                If Me.tbl_TrnJurnal_Temp.Rows(0).Item("jurnal_isposted") = 0 Then
                    ...
                    If tbl_checkacc_id.Rows.Count <> 0 Then
...
#Region "Event On Dgv Credit"
                        ...
                        If tbl_banktransfer.Rows.Count >= 1 Then
                            ...
                            If dlgSelectRekeningPrint.DialogResult = DialogResult.OK Then
                                With dlgSelectRekeningPrint
                                    ...
                                    Rekanan_name = IIf(.chkRekananName.CheckState = CheckState.Checked, .txtRekananName.Text, "") '.dgvRekening.Rows(.dgvRekening.CurrentRow.Index).Cells("banktransfer_message").Value.ToString
    ...
    Private Sub DgvTrnJurnaldetil_Credit_CellValidated(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnJurnaldetil_Credit.CellValidated
        ...
        If colName = "jurnaldetil_foreign" Or colName = "jurnaldetil_foreignrate" Then
            ...
            '=================REMARK BY PTS=============================
            'If obj.Rows(e.RowIndex).Cells("acc_id").Value <> akun8002000 And obj.Rows(e.RowIndex).Cells("acc_id").Value <> 8001000 Then
            '    Me.uiTrnJurnal_PV_Manual_RowCalcIDR(obj, obj.Rows(e.RowIndex).Cells("jurnaldetil_idr"), obj.Rows(e.RowIndex).Cells("jurnaldetil_foreign"), obj.Rows(e.RowIndex).Cells("jurnaldetil_foreignrate"))
            'End If
            '===========================================================
            If obj.Rows(e.RowIndex).Cells("acc_id").Value <> akun8002000 And obj.Rows(e.RowIndex).Cells("acc_id").Value <> 7202120 Then
                Me.uiTrnJurnal_PV_Manual_RowCalcIDR(obj.Rows(e.RowIndex).Cells("branch_id"), obj.Rows(e.RowIndex).Cells("acc_id"), obj.Rows(e.RowIndex).Cells("jurnaldetil_idr"), obj.Rows(e.RowIndex).Cells("jurnaldetil_foreign"), obj.Rows(e.RowIndex).Cells("jurnaldetil_foreignrate"))
            End If
...
#Region " Print "
    Private Function uiTrnJurnal_PV_Manual_Print() As Boolean
        Dim retObj As Object
        Dim i, j As Integer
        ...
        If Me.isPrint = "PaymentVoucher" Then
            If Me.ftabMain.SelectedIndex = 0 Then
                For i = 0 To Me.DgvTrnJurnal.SelectedRows.Count - 1
                    ...
                    If Me._USER_TYPE = "SPV" Then
                        objReportH.ReportEmbeddedResource = "ACT_FINANCE.rptPV_HeaderManual_Post.rdlc"
                    Else
                    ...
                    'Using report As New clsQuickPrintPV_manual(objReportH)
                    '    report.Print()
                    'End Using

                    Using report As New clsQuickPrint(objReportH)
                        report.Print("0.1in", "0.3in", "0.1in", "0.1in")
                    End Using
                Next
        ...
        ElseIf Me.isPrint = "Jurnal" Then
            If Me.ftabMain.SelectedIndex = 0 Then
                For i = 0 To Me.DgvTrnJurnal.SelectedRows.Count - 1
                    ...
                    objRdsH.Value = objDatalistHeader
                    If Me._USER_TYPE = "SPV" Then
                        objReportH.ReportEmbeddedResource = "ACT_FINANCE.rptJurnal_PV_Manual_Post_Header.rdlc"
                    Else
                ...
                For i = 0 To Me.DgvTrnJurnal.SelectedRows.Count - 1
                    ...
                    For j = 0 To Tbl_TrnJurnalDetil_kredit_temp.Rows.Count - 1
                        If clsUtil.IsDbNull(Tbl_TrnJurnalDetil_kredit_temp.Rows(j).Item("paymenttype_id"), 0) = 2 Or _
                            ...
                            If clsUtil.IsDbNull(Tbl_TrnJurnalDetil_kredit_temp.Rows(j).Item("paymenttype_id"), 0) = 2 Then
                                If Me._USER_TYPE = "SPV" Then
                                    objReportH.ReportEmbeddedResource = "ACT_FINANCE.rptPV_Manual_Cek_Post.rdlc"
                                Else
                                    objReportH.ReportEmbeddedResource = "ACT_FINANCE.rptPV_Manual_Cek.rdlc"
                                End If
                            Else
                                If Me._USER_TYPE = "SPV" Then
                                    objReportH.ReportEmbeddedResource = "ACT_FINANCE.rptPV_Manual_BG_Post.rdlc"
                                Else
                                    objReportH.ReportEmbeddedResource = "ACT_FINANCE.rptPV_Manual_BG.rdlc"
                                End If
                            End If
                            objReportH.DataSources.Add(objRdsH)
                            objReportH.EnableExternalImages = True
    ...
    Private Function GenerateDataDetail() As ArrayList
        ...
        '==============ADD BY PTS 20130726====================================
        Me.DataFill(dt_accref1, "act_selectAccRef_Detil", "accref_id = '" & Me.accref1 & "'")
        Me.DataFill(dt_accref2, "act_selectAccRef_Detil", "accref_id = '" & Me.accref2 & "'")
        '=====================================================================
    ...
    Private Function GenerateDataDetailPayment() As ArrayList
        ...
        Me.DataFill(dt_accref1, "act_selectAccRef_Detil", "accref_id = '" & Me.accref5 & "'") '8500011
        Me.DataFill(dt_accref2, "act_selectAccRef_Detil", "accref_id = '" & Me.accref6 & "'") '1950420
        Me.DataFill(dt_accref3, "act_selectAccRef_Detil", "accref_id = '" & Me.accref7 & "'") '1950430  	 
        Me.DataFill(dt_accref4, "act_selectAccRef_Detil", "accref_id = '" & Me.accref8 & "'") '1950920
    ...
    Private Function CreateStream _
      ...
      As System.IO.Stream
        Dim stream As System.IO.Stream = New System.IO.FileStream("Temp\" & name & "." & fileNameExtension, System.IO.FileMode.Create)
    ...
    End Sub
    Private Function uiTrnJurnal_PV_Manual_PrintPreview() As Boolean
        Dim retObj As Object
...
#Region " Untuk BackgroundWorker"
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        If BG_Worker.CancellationPending Then
            e.Cancel = True
        Else
            Me.uiTrnJurnal_PV_Manual_CollectionData_with_BackgroundWorker(BG_Worker)
        End If
    ...
    Public Sub uiTrnJurnal_PV_Manual_newBackgroundWorker()
        Me.BackgroundWorker1 = New BackgroundWorker
        BackgroundWorker1.RunWorkerAsync()
    End Sub

    Private Sub uiTrnJurnal_PV_Manual_CollectionData_with_BackgroundWorker(ByVal worker As BackgroundWorker)
        ...
        '====== Add PTS 20130726 master_setting=======================================================================
        Dim tbl_setting_accref1 As DataTable = New DataTable
        Dim tbl_setting_accref2 As DataTable = New DataTable
        Dim tbl_setting_accref3 As DataTable = New DataTable
        Dim tbl_setting_accref4 As DataTable = New DataTable

        Dim tbl_setting_accref5 As DataTable = New DataTable
        Dim tbl_setting_accref6 As DataTable = New DataTable
        Dim tbl_setting_accref7 As DataTable = New DataTable
        Dim tbl_setting_accref8 As DataTable = New DataTable

        'Dim accref1 As String
        'Dim accref2 As String
        'Dim accref3 As String
        'Dim accref4 As String

        tbl_setting_accref1.Clear()
        tbl_setting_accref2.Clear()
        tbl_setting_accref3.Clear()
        tbl_setting_accref4.Clear()

        tbl_setting_accref5.Clear()
        tbl_setting_accref6.Clear()
        tbl_setting_accref7.Clear()
        tbl_setting_accref8.Clear()

        Me.DataFill(tbl_setting_accref1, "cp_MstSetting_Select", "setting_id = 'PVMnl_BiKerugKursPjk_AccRefId'") '//PVMnl_BiKerugKursPjk_AccRefId
        Me.DataFill(tbl_setting_accref2, "cp_MstSetting_Select", "setting_id = 'PVMnl_PenSlshKursPjk_AccRefId'") '//PVMnl_PenSlshKursPjk_AccRefId
        Me.DataFill(tbl_setting_accref3, "cp_MstSetting_Select", "setting_id = 'PVMnl_BiLainnya_AccRefId'") '//PVMnl_BiLainnya_AccRefId
        Me.DataFill(tbl_setting_accref4, "cp_MstSetting_Select", "setting_id = 'PVMnl_PendLainnya_AccRefId'") '//PVMnl_PendLainnya_AccRefId

        Me.DataFill(tbl_setting_accref5, "cp_MstSetting_Select", "setting_id = 'PVMnl_BiKerugKurs_AccRefId'") '//PVMnl_BiKerugKurs_AccRefId
        Me.DataFill(tbl_setting_accref6, "cp_MstSetting_Select", "setting_id = 'PVMnl_ClearAccPPHFinal_AccRefId'") '//PVMnl_ClearAccPPHFinal_AccRefId
        Me.DataFill(tbl_setting_accref7, "cp_MstSetting_Select", "setting_id = 'PVMnl_ClearAccPjkArtis_AccRefId'") '//PVMnl_ClearAccPjkArtis_AccRefId
        Me.DataFill(tbl_setting_accref8, "cp_MstSetting_Select", "setting_id = 'PVMnl_ClearAccPPH23_AccRefId'") '//PVMnl_ClearAccPPH23_AccRefId

        Me.accref1 = tbl_setting_accref1.Rows(0).Item("setting_value").ToString 'Keterangan : PVMnl_BiKerugKursPjk_AccRefId - 3201
        Me.accref2 = tbl_setting_accref2.Rows(0).Item("setting_value").ToString 'Keterangan : PVMnl_PenSlshKursPjk_AccRefId -3202
        Me.accref3 = tbl_setting_accref3.Rows(0).Item("setting_value").ToString 'Keterangan : PVMnl_BiLainnya_AccRefId - 3301
        Me.accref4 = tbl_setting_accref4.Rows(0).Item("setting_value").ToString 'Keterangan : PVMnl_PendLainnya_AccRefId - 3302

        Me.accref5 = tbl_setting_accref5.Rows(0).Item("setting_value").ToString 'Keterangan : PVMnl_BiKerugKurs_AccRefId - 3101
        Me.accref6 = tbl_setting_accref6.Rows(0).Item("setting_value").ToString 'Keterangan : PVMnl_ClearAccPPHFinal_AccRefId - 5701
        Me.accref7 = tbl_setting_accref7.Rows(0).Item("setting_value").ToString 'Keterangan : PVMnl_ClearAccPjkArtis_AccRefId - 5801
        Me.accref8 = tbl_setting_accref8.Rows(0).Item("setting_value").ToString 'Keterangan : PVMnl_ClearAccPPH23_AccRefId - 5901

        '====================================================================================================

        '======================= ari =================Modified PTS 20130726==================================
        Dim dt_accref1 As DataTable = New DataTable
        Dim dt_accref2 As DataTable = New DataTable
        Dim dt_accref3 As DataTable = New DataTable
        Dim dt_accref4 As DataTable = New DataTable
        ...
        Me.DataFill(dt_accref1, "act_selectAccRef_Detil", "accref_id = '" & Me.accref1 & "'") '3201") 
        Me.DataFill(dt_accref2, "act_selectAccRef_Detil", "accref_id = '" & Me.accref2 & "'") '3202") 
        Me.DataFill(dt_accref3, "act_selectAccRef_Detil", "accref_id = '" & Me.accref3 & "'") '3301") 
        Me.DataFill(dt_accref4, "act_selectAccRef_Detil", "accref_id = '" & Me.accref4 & "'") '3302") 
        Me.DataFill(dt_accref5, "act_selectAccRef_Detil", "accref_id = 3102") ' 
        Me.DataFill(dt_accref6, "act_selectAccRef_Detil", "accref_id = 3101") ' 
        akun8500015 = dt_accref1.Rows(0).Item(0) '==========> Biaya Lain-lain - Kerugian - Selisih Kurs
        akun8002000 = dt_accref2.Rows(0).Item(0) '==========> (Keuntungan) Lain-lain - Selisih Kurs
        akun8009990 = dt_accref3.Rows(0).Item(0) '==========> (Pendapatan) Lain-lain - Lain-lain
        akun8509990 = dt_accref4.Rows(0).Item(0) '==========> Biaya Lain-lain - Biaya - Adm
        akun8001000 = dt_accref5.Rows(0).Item(0)
        akun8500011 = dt_accref6.Rows(0).Item(0)
        '=======================================================
    End Sub

    Private Sub uiTrnJurnal_PV_Manual_isBackgroudWorker()
        ...
        If Me.isBackGroundWorker_isWork = False Then
            ...
            If Me.isBackgroundWorker = False Then
                ...
                If Me.BackgroundWorker1.IsBusy Then
                    ...
                    Me.uiTrnJurnal_PV_Manual_newBackgroundWorker()
                Else
    ...
    Private Sub uiTrnJurnal_PV_Manual_LoadComboBox()
...
#End Region
    ...
    Private Function uiTrnJurnal_PV_Manual_RowCalculate(ByVal dgv_D As DataGridView, ByVal dgv_K As DataGridView, ByRef selisih As Decimal, ByRef jumlah As Decimal) As Boolean
        Dim i As Integer
    ...
    Private Function uiTrnJurnal_PV_Manual_RowCalculateForeign(ByVal dgv_D As DataGridView, ByVal dgv_K As DataGridView, ByRef selisih As Decimal, ByRef jumlah As Decimal) As Boolean
        Dim i As Integer
        Dim value As Decimal
    ...
    Private Function uiTrnJurnal_PV_Manual_RowCalculateForeignIDR(ByVal dgv_D As DataGridView, ByVal dgv_K As DataGridView, ByRef selisih As Decimal, ByRef jumlah As Decimal) As Boolean
        Dim i As Integer
        Dim value As Decimal
        Dim cellForeign As DataGridViewCell
        Dim dgv As DataGridView
    ...
    Private Function uiTrnJurnal_PV_Manual_RowCalcIDR(ByVal cellBranchID As DataGridViewCell, ByVal cellAccID As DataGridViewCell, ByVal cellIDR As DataGridViewCell, ByVal cellForeign As DataGridViewCell, ByVal cellRate As DataGridViewCell) As Boolean
        ...
        If obj_Jurnal_isposted.CheckState = CheckState.Unchecked Then
            If cellBranchID.Value = 0 Then 'dgv.CurrentRow.Cells("branch_id").Value = 0 Then 'branch_id (TANDA UNTUK UBAH DARI RATE TAX ATAU AMOUNT IDR TAX)
                If cellAccID.Value <> akun8500015 And cellAccID.Value <> akun8002000 And _
                    cellAccID.Value <> akun8009990 And cellAccID.Value <> akun8509990 And _
                    cellAccID.Value <> akun8500011 And cellAccID.Value <> akun8001000 Then
    ...
    Private Function uiTrnJurnal_PV_Manual_TblDetilInverse(ByVal tbl As DataTable) As Boolean
        Dim i As Integer
    ...
    Private Function uiTrnJurnal_PV_Manual_SetDefaultValueOfJurnaldetil_Debit(ByVal sender As System.Object, ByVal columnname As String) As Boolean
        Dim id As String
    ...
    Private Function uiTrnJurnal_PV_Manual_SetDefaultValueOfJurnaldetil_Credit(ByVal sender As System.Object, ByVal columnname As String) As Boolean
        Dim id As String
        Dim cbo As ComboBox = sender
        Try
            If cbo.SelectedValue IsNot Nothing Then
    ...
    Private Function uiTrnJurnal_PV_Manual_DataIsLocked() As Boolean
    ...
    Private Sub obj_Rekanan_id_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles obj_Rekanan_id.Validated
        ...
        Me.uiTrnJurnal_PV_Manual_SetDefaultValueOfJurnaldetil_Debit(sender, cbo.ValueMember)
        Me.uiTrnJurnal_PV_Manual_SetDefaultValueOfJurnaldetil_Credit(sender, cbo.ValueMember)
    ...
    Private Sub ChangeFeeRateToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChangeFeeRateToolStripMenuItem.Click
        Dim rate As String
        Dim row As DataRow
        Dim selisih_idr, jumlah_idr, selisih_foreign, jumlah_foreign As Decimal
        Dim amountChangeSelisih As Decimal = 0
    ...
    '========================ADD PTS 20130711==================
    Private Function uiTrnJurnal_PV_Manual_OpenRowContract(ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnJurnal_PV_Manual_OpenRowContract()" & vbCrLf & ex.Message)
        End Try
    ...
    Private Sub btnUpload_Click(sender As Object, e As EventArgs) Handles btnUpload.Click
        ...
        If Me.OpenFileDialog1.ShowDialog = DialogResult.OK Then
            ...
            ImportToDetail(cPathExcel)
        End If
    End Sub

    Public Function ImportToDetail(ByVal PrmPathExcelFile As String) As Boolean
        ...
        Dim MasterDataState As System.Data.DataRowState
        Dim acc_id, budget_id, rekanan_id, budgetdetil_id, acc_ca_id, bank_id, bankacc_account As Decimal
        Dim rekanan_name, budget_name, budgetdetil_name, acc_ca_name, bank_name As String
        ...
        Try
            ...
            For i = 0 To DataTempAll.Rows.Count - 1
                ...
                acc_ca_id = clsUtil.IsDbNull(DataTempAll.Rows(i).Item("acc_ca_id"), 0)
                If acc_ca_id = 0 Then
                    acc_ca_name = ""
                Else
                    dtRow = Me.tbl_MstAcc_ca.Select("acc_ca_id = '" & DataTempAll.Rows(i).Item("acc_ca_id") & "'")
                    acc_ca_name = ""
                    For n As Integer = 0 To (dtRow.Length - 1)
                        acc_ca_name = dtRow(n)("acc_ca_name").ToString
                    Next
                End If
                '==========================================================================================================================================================

                bank_id = clsUtil.IsDbNull(DataTempAll.Rows(i).Item("bank_id"), 0)
                If bank_id = 0 Then
                    bank_name = ""
                    bankacc_account = 0
                Else
                    dtRow = Me.tbl_MstBankacc.Select("bankacc_id = '" & DataTempAll.Rows(i).Item("bank_id") & "'")
                    bank_name = ""
                    bankacc_account = 0
                    For n As Integer = 0 To (dtRow.Length - 1)
                        bank_name = dtRow(n)("bankacc_reportname").ToString
                        bankacc_account = dtRow(n)("bankacc_account").ToString
                    Next
                End If
                '==========================================================================================================================================================

                acc_id = clsUtil.IsDbNull(DataTempAll.Rows(i).Item("acc_id"), 0)
                'If acc_id = 0 Then
                '    acc_name = ""
                'Else
                '    dtRow = Me.tbl_MstAccGrid.Select("acc_id = '" & DataTempAll.Rows(i).Item("acc_id") & "'")
                '    acc_name = ""
                '    For n As Integer = 0 To (dtRow.Length - 1)
                '        acc_name = dtRow(n)("acc_name").ToString
                '    Next
                'End If
                '==========================================================================================================================================================
                ' Jika bank_id tidak kosong, ambil nilai bankacc_account untuk menganti nilai dari acc_id
                '==========================================================================================================================================================
                If bankacc_account <> 0 Then
                    acc_id = bankacc_account
                    'dtRow = Me.tbl_MstAccGrid.Select("acc_id = '" & bankacc_account & "'")
                    'acc_name = ""
                    'For n As Integer = 0 To (dtRow.Length - 1)
                    '    acc_name = dtRow(n)("acc_name").ToString
                    'Next
                ...
                If DataTempAll.Rows(i).Item("detil") = "K" Then
                    ...
                    DgvTrnJurnaldetil_Credit.Rows(DgvTrnJurnaldetil_Credit.CurrentCell.RowIndex).Cells("acc_id").Value = acc_id ' DataTempAll.Rows(i).Item("acc_id")
                    ...
                    DgvTrnJurnaldetil_Credit.Rows(DgvTrnJurnaldetil_Credit.CurrentCell.RowIndex).Cells("jurnalbilyet_bank").Value = bank_id
                    DgvTrnJurnaldetil_Credit.Rows(DgvTrnJurnaldetil_Credit.CurrentCell.RowIndex).Cells("region_id").Value = acc_ca_id
                End If
    ...
    Private Sub btnTemplateXLS_Click(sender As Object, e As EventArgs) Handles btnTemplateXLS.Click
        ...
        dtTemplateExcel.Columns.Add("bank_id")
        dtTemplateExcel.Columns.Add("acc_ca_id")

        Dim path As String
        path = System.IO.Path.GetTempPath + "TemplatePV_XLS.xlsx"
    ...
    Private Sub ExportToExcel(ByVal dtTemp As DataTable, ByVal filepath As String)
        ...
        '    If CekXLSOpen("TemplatePV_XLS.xlsx") = True Then
        '        MsgBox("Close Excel Windows First !!", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly, mUiName)
        '        wBook.Close(False)
        '        'wBook.Application.Workbooks(filepath).Close()
        '        Exit Sub
        '    End If
    ...
    Function CekXLSOpen(ByRef sName As String) As Boolean
