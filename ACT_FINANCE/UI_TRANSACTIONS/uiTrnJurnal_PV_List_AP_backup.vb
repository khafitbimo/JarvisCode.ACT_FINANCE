...
Public Class uiTrnJurnal_PV_List_AP_backup
...
#Region " Window Parameter "
    ...
    Private _USER_TYPE As String = "STAFF" '"STAFF" 'SPV 'STAFF
#End Region
...
#Region " Additional Overrides "
    ...
    Private Sub btnPost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPost.Click, btnUnPost.Click
        ...
        ''tambahan
        'Dim clsTrnDocument As New clsTrnDocument(DSN, Me._CHANNEL)
        ''end tambahan
        If obj.Name = "btnPost" Then
            ...
            Try
                ...
                'tambahan
                'Dim sukses As Boolean = clsTrnDocument.ifExist(tbl_trnJurnalDocument, Me.obj_Jurnal_id.Text)
                'If sukses Then
                '    MsgBox("update post")
                'Else
                '    clsTrnDocument.SaveTrnDocument(Me.obj_Jurnal_id.Text, Me.UserName, dbConn)
                'End If
                'end tambahan
                dbTrans.Commit()
...
#Region " User Defined Function "
    ...
    Private Function uiTrnJurnal_PV_List_AP_OpenRow(ByVal rowIndex As Integer) As Boolean
        ...
        Try
            ...
            uiTrnJurnal_PV_List_AP_OpenRowContractBank2(channel_id, jurnal_id, dbConn)
    ...
    Private Function uiTrnJurnal_PV_List_AP_OpenRowBankLink(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        ...
        '=================================================================================================
        ' Modify By MDP2 NET 27 Juni 2014 15:54 WIB
        '=================================================================================================
