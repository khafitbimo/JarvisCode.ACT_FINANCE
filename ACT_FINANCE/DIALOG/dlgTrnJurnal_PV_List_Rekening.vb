Public Class dlgTrnJurnal_PV_List_Rekening
...
#Region " Opener "
    Public Shadows Function OpenDialog(ByVal owner As System.Windows.Forms.IWin32Window) As Object
        ...
        'tbl_typeRekananSearch.Columns.Add(New DataColumn("value_type", GetType(System.Decimal)))
        'tbl_typeRekananSearch.Columns.Add(New DataColumn("display_type", GetType(System.String)))
        'If tbl_typeRekananSearch.Columns("display_type") IsNot Nothing Then

        '    row_type = tbl_typeRekananSearch.NewRow
        '    row_type.Item("value_type") = 0
        '    row_type.Item("display_type") = "Management"
        '    tbl_typeRekananSearch.Rows.InsertAt(row_type, 0)

        '    row_type = tbl_typeRekananSearch.NewRow
        '    row_type.Item("value_type") = 1
        '    row_type.Item("display_type") = "Unit Talent"
        '    tbl_typeRekananSearch.Rows.InsertAt(row_type, 1)

        '    row_type = tbl_typeRekananSearch.NewRow
        '    row_type.Item("value_type") = 2
        '    row_type.Item("display_type") = "Artist"
        '    tbl_typeRekananSearch.Rows.InsertAt(row_type, 1)

        '    tbl_typeRekananSearch.DefaultView.Sort = "display_type"
        '    Me.obj_type_search.DataSource = tbl_typeRekananSearch
        '    Me.obj_type_search.ValueMember = "value_type"
        '    Me.obj_type_search.DisplayMember = "display_type"
        '    Me.obj_type_search.SelectedValue = 2
        'End If
        ...
        ElseIf Me.TombolRekeningClick = "artis" Then
            ...
            'Me.dlgTrnJurnalPVSelect_rekening_OpenRowDetilRekeningRekanan(Me.dgvArtisName.Rows(Me.dgvArtisName.CurrentRow.Index).Cells("code").Value, dbConn)
        End If
        '==============================================
