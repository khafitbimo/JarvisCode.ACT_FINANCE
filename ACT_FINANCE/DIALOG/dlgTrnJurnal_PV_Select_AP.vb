...
' Created Date: 10/17/2010 3:59 PM
Public Class dlgTrnJurnal_PV_Select_AP
    ...
    Private tbl_TrnJurnalAP As DataTable = CreateTblTrnJurnalDetilPVListAP()
...
#Region " Constructor & Default Function"
    Public Sub New(ByVal dsn As String, _
                ByVal tbl_MstRekananGrid As DataTable, ByVal tbl_MstAccGrid As DataTable, ByVal channel As String)
    ...
    Public Shadows Function OpenDialog(ByVal owner As System.Windows.Forms.IWin32Window, _
                ByVal channel_id As String, ByVal source As String, ByVal tbl_exception As DataTable) As Object
...
#Region " UI Layout & Format "
    ...
    End Function
    Function CreateTblTrnJurnalDetilPVListAP() As DataTable
        Dim tbl As DataTable = New DataTable
        ...
        Return tbl
    End Function
    Private Function FormatDgvTrnJurnalDetilPVListAP(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        cJurnaldetil_idr_outstanding, cJurnaldetil_descr, cJurnal_bookdate, cAcc_id, cAcc_name, _
        cJurnaldetil_receive, cJurnaldetil_idr, _
...
#Region " User defined function "
    Private Function dlgTrnJurnalDetilSelect_Load(ByVal channel_id As String) As Boolean
        ...
        Dim tbl_DetilSA As DataTable = CreateTblTrnJurnalDetilPVListAP()
        Dim criteria = ""
        ...
        If Me.chkSearchSource.Checked = True Then
            txtSQLSearch = txtSQLSearch & " LEFT(A.jurnal_id, 2) = 'AP' "
        End If

        If Me.chkSearchJurnalID.Checked Then
            txtSearchCriteria = clsUtil.RefParser("A.jurnal_id", Me.obj_jurnal_id)
        ...
        If Me.chkAccount.Checked Then
            txtSearchCriteria = String.Format(" A.acc_id = '{0}' ", Me.obj_Acc_H.Text)
            If txtSQLSearch = "" Then
                txtSQLSearch = " (" & txtSearchCriteria & ") "
            Else
                txtSQLSearch = txtSQLSearch & " AND " & " (" & txtSearchCriteria & ") "
        ...
        If Me.mSource = "PV-ListAP" Then
            dbCmd = New OleDb.OleDbCommand("act_TrnJurnaldetil_PV_Select_AP2", dbConn)
        Else
            dbCmd = New OleDb.OleDbCommand("act_TrnJurnaldetil_PV_Tax_Select_AP2", dbConn)
        End If
            ...
            If Me.tbl_exception.Rows.Count <> 0 Then
                ...
                For Each row As DataRow In Me.tbl_exception.Rows
                    If row.RowState <> DataRowState.Deleted Then
                        ref = row.Item("ref")
                        line = row.Item("line")
                        rows = Me.tbl_TrnJurnalAP.Select(String.Format("jurnal_id = '{0}' and jurnaldetil_line = {1}", ref, line))
                ...
                Me.tbl_TrnJurnalAP.AcceptChanges()
            End If
            '==============================================================

            Me.DgvDetil.DataSource = Me.tbl_TrnJurnalAP
...
#End Region
    ...
    Private Sub dlgTrnJurnal_PV_Select_AP_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Cursor = Cursors.WaitCursor
        Me.FormatDgvTrnJurnalDetilPVListAP(Me.DgvDetil)
        ...
        Me.obj_Source.Items.Add("Jurnal AP")
        Me.obj_Source.SelectedItem = "Jurnal AP"
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Me.dlgTrnJurnalDetilSelect_Load(Me._channel)
        Me.DgvDetil.DataSource = Me.tbl_TrnJurnalAP
    End Sub
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        ...
        Dim tbl_TrnJurnal_temp As DataTable = CreateTblTrnJurnalDetilPVListAP()
        Dim i As Integer
        ...
        tbl_TrnJurnal_temp = Me.tbl_TrnJurnalAP.Copy()
        ...
        If Me.DgvDetil.CurrentRow IsNot Nothing Then
            If tbl_TrnJurnal_temp.DefaultView.Count > 0 Then
                For i = 0 To tbl_TrnJurnal_temp.DefaultView.Count - 1
                    ...
                    row.Item("jurnal_descr") = tbl_TrnJurnal_temp.DefaultView.Item(i).Item("jurnal_descr")
                    ...
                    row.Item("acc_id") = tbl_TrnJurnal_temp.DefaultView.Item(i).Item("acc_id")
                    ...
                    row.Item("ref_budgetline") = tbl_TrnJurnal_temp.DefaultView.Item(i).Item("budgetdetil_line")
                    row.Item("budget_id") = tbl_TrnJurnal_temp.DefaultView.Item(i).Item("budget_id")
                    row.Item("budget_name") = tbl_TrnJurnal_temp.DefaultView.Item(i).Item("budget_name")
                    row.Item("budgetdetil_id") = tbl_TrnJurnal_temp.DefaultView.Item(i).Item("budgetdetil_id")
                    row.Item("budgetdetil_name") = tbl_TrnJurnal_temp.DefaultView.Item(i).Item("budgetdetil_name")
                    row.Item("rekanan_id") = tbl_TrnJurnal_temp.DefaultView.Item(i).Item("rekanan_id")
    ...
    Private Function dlgTrnJurnalPV_Select_AP_verify()
        Dim i As Integer
        Dim tbl_TrnJurnaldetilTemp As DataTable = CreateTblTrnJurnalDetilPVListAP()
        Dim cekCurr As String = ""
        Dim cekRekanan As String = ""
        Dim cekAccount As String = ""

        tbl_TrnJurnaldetilTemp.Clear()
        tbl_TrnJurnaldetilTemp = Me.tbl_TrnJurnalAP.Copy()
