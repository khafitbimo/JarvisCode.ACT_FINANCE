...
Public Class dlgTrnJurnal_PV_Select_AdvanceTravel
    ...
    Private tbl_TrnAdvanceTravel_Header As DataTable = CreateTblTrnAdvanceHeader()
...
#Region " UI Layout & Format "
    ...
    Function CreateTblTrnAdvanceHeader() As DataTable
        Dim tbl As DataTable = New DataTable
        ...
        tbl.Columns("advance_descr").DefaultValue = ""
        tbl.Columns("advance_usedby").DefaultValue = ""
        tbl.Columns("source_id").DefaultValue = ""
    ...
    Private Function FormatDgvTrnJurnalDetilPVListVQ_Order(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        cJurnaldetil_check.ReadOnly = True
    ...
    Private Function FormatDgvTrnJurnalDetilPVListVQ_TravelHeader(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        Dim cAdvance_id As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cAdvance_Descr As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cAdvance_Usedby As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cSource_id As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cRekanan_id As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cRekanan_name As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        ...
        objDgv.Columns.Clear()
        objDgv.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() _
        {cAdvance_id, cAdvance_Descr, cRekanan_id, cRekanan_name, cAdvance_Usedby, cSource_id})
...
#Region " User defined function "
    Private Function dlgTrnJurnalDetilSelect_Load(ByVal rowIndex As Integer, ByVal channel_id As String, ByVal SourcePV As String) As Boolean
        ...
        Dim advance_id As String = Me.dgvHeader.Rows(rowIndex).Cells("advance_id").Value
        ...
        Try
            ...
            For Each rows As DataRow In Me.tbl_TrnJurnalPV.Rows
                rows.Item("jurnaldetil_check") = True
            Next
    ...
    Private Function dlgTrnJurnalDetilSelect_LoadHeader(ByVal channel_id As String, ByVal SourcePV As String) As Boolean
        Me.Cursor = Cursors.WaitCursor
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        If Me.chkRekanan.Checked Then
            txtSearchCriteria = String.Format(" b.rekanan_id = '{0}' ", Me.obj_Rekanan_id.Text)
        ...
        If SourcePV = "PV-ListAdvanceTravel" Then
            dbCmd = New OleDb.OleDbCommand("act_TrnJurnaldetil_PV_SelectHeader_VQ_Travel", dbConn)
        End If

        dbCmd.Parameters.Add("@channel_id", Data.OleDb.OleDbType.VarWChar)
        dbCmd.Parameters("@channel_id").Value = channel_id
        dbCmd.Parameters.Add("@source_id", Data.OleDb.OleDbType.VarWChar)
        dbCmd.Parameters("@source_id").Value = obj_Source.Text
        ...
        dbCmd.CommandType = CommandType.StoredProcedure
        dbDA = New OleDb.OleDbDataAdapter(dbCmd)
        tbl_TrnAdvanceTravel_Header.Clear()
        tbl_TrnAdvanceTravel_Header = CreateTblTrnAdvanceHeader()
        ...
        Try
            dbConn.Open()
            clsApplicationRole.SetAppRole(dbConn, cookie)
            dbDA.Fill(Me.tbl_TrnAdvanceTravel_Header)
            ...
            If Me.tbl_exception.Rows.Count <> 0 Then
                ...
                For Each row As DataRow In Me.tbl_exception.Rows
                    If row.RowState <> DataRowState.Deleted Then
                        ref = row.Item("ref")
                        line = row.Item("line")
                        rows = Me.tbl_TrnAdvanceTravel_Header.Select(String.Format("advance_id = '{0}'", ref))
                ...
                Me.tbl_TrnAdvanceTravel_Header.AcceptChanges()
            End If
            '==============================================================

            Me.dgvHeader.DataSource = Me.tbl_TrnAdvanceTravel_Header
        Catch ex As Exception
            MessageBox.Show(ex.Message, "dlgTrnJurnalSelect" & ": dlgTrnJurnalDetilSelect_LoadDetil()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            clsApplicationRole.UnsetAppRole(dbConn, cookie)
...
#End Region
    ...
    Private Sub dlgTrnJurnal_PV_Select_Advance_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.Source = "PV-ListAdvanceTravel" Then
            Me.FormatDgvTrnJurnalDetilPVListVQ_TravelHeader(Me.dgvHeader)
        ...
        Me.obj_Source.Items.Add("Advance Travel")

        If Me.Source = "PV-ListAdvanceTravel" Then
            Me.Text = "Jurnal PV - List Advance Travel (VQ)"
            Me.obj_Source.SelectedItem = "Advance Travel"
        End If
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Me.dlgTrnJurnalDetilSelect_LoadHeader(mChannel_id, Me.Source)
        Me.DgvDetil.DataSource = Me.tbl_TrnJurnalPV
    End Sub
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        ...
        If Me.Source = "PV-ListAdvanceOrder" Or Me.Source = "PV-ListAdvanceTravel" Then
            ...
            If Me.DgvDetil.CurrentRow IsNot Nothing Then
                If tbl_TrnJurnal_temp.DefaultView.Count > 0 Then
                    For i = 0 To tbl_TrnJurnal_temp.DefaultView.Count - 1
                        If Me.Source <> "PV-ListAdvanceOrder" And Me.Source <> "PV-ListAdvanceTravel" Then
    ...
    Private Sub dgvHeader_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvHeader.CellDoubleClick
        If e.ColumnIndex < 0 Or e.RowIndex < 0 Then
            Exit Sub
        End If
        If Me.dgvHeader.CurrentRow IsNot Nothing Then
    ...
    Private Sub TabControl1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles TabControl1.SelectedIndexChanged
        Select Case TabControl1.SelectedIndex
            ...
            Case 1
                Me.dlgTrnJurnalDetilSelect_Load(Me.dgvHeader.CurrentRow.Index, mChannel_id, Me.Source)
                Me.DgvDetil.DataSource = Me.tbl_TrnJurnalPV
        End Select
    End Sub
End Class
