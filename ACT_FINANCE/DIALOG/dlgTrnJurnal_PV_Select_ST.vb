...
Public Class dlgTrnJurnal_PV_Select_ST
    ...
    Private tbl_TrnJurnalST As DataTable = CreateTblTrnJurnalDetilPVListST()
...
#Region " UI Layout & Format "
    ...
    End Function
    Function CreateTblTrnJurnalDetilPVListST() As DataTable
        Dim tbl As DataTable = New DataTable
        ...
        Return tbl
    End Function
    Private Function FormatDgvTrnJurnalDetilPVListST(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
...
#Region " User defined function "
    Private Function dlgTrnJurnalDetilSelect_Load(ByVal channel_id As String) As Boolean
        ...
        Dim tbl_DetilSA As DataTable = CreateTblTrnJurnalDetilPVListST()
        Dim criteria = ""
        ...
        dbCmd = New OleDb.OleDbCommand("act_TrnJurnaldetil_PV_Select_ST", dbConn)
            ...
            If Me.tbl_exception.Rows.Count <> 0 Then
                ...
                For Each row As DataRow In Me.tbl_exception.Rows
                    If row.RowState <> DataRowState.Deleted Then
                        ref = row.Item("ref")
                        line = row.Item("line")
                        rows = Me.tbl_TrnJurnalST.Select(String.Format("jurnal_id = '{0}' and jurnaldetil_line = {1}", ref, line))
                ...
                Me.tbl_TrnJurnalST.AcceptChanges()
            End If
            '==============================================================
...
#End Region
    ...
    Private Sub dlgTrnJurnal_PV_Select_ST_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Cursor = Cursors.WaitCursor
        Me.FormatDgvTrnJurnalDetilPVListST(Me.DgvDetil)
        ...
        Me.obj_Source.Items.Add("Jurnal ST")
        Me.obj_Source.SelectedItem = "Jurnal ST"
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        ...
        Dim tbl_TrnJurnal_temp As DataTable = CreateTblTrnJurnalDetilPVListST()
        Dim i As Integer

        If Me.dlgTrnJurnalPV_Select_ST_verify() = False Then
            Exit Sub
        End If

        tbl_TrnJurnal_temp.Clear()
        tbl_TrnJurnal_temp = Me.tbl_TrnJurnalST.Copy()
    ...
    Private Function dlgTrnJurnalPV_Select_ST_verify()
        Dim i As Integer
        Dim tbl_TrnJurnaldetilTemp As DataTable = CreateTblTrnJurnalDetilPVListST()
        Dim cekCurr As String = ""
        Dim cekRekanan As String = ""
        Dim cekAccount As String = ""

        tbl_TrnJurnaldetilTemp.Clear()
        tbl_TrnJurnaldetilTemp = Me.tbl_TrnJurnalST.Copy()
