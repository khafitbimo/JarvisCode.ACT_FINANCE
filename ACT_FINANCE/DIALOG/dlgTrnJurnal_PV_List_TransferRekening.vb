...
#Region " Constructor & Default Function"
    ...
    Public Sub New(ByVal dsn As String,
                    ...
                    Optional ByVal rekanan As Integer = 0)
    ...
    Public Shadows Function OpenDialog(ByVal owner As System.Windows.Forms.IWin32Window) As Object
        If Me.BtnRekArtisStatus = "RekArtisOn" Then
            Me.btn_RekeningArtis.Enabled = True
            Me.btn_RekeningArtis.Visible = True

        Else
            Me.btn_RekeningArtis.Enabled = False
            Me.btn_RekeningArtis.Visible = False
        End If
...
#End Region
    ...
    Private Sub btn_RekeningArtis_Click(sender As Object, e As EventArgs) Handles btn_RekeningArtis.Click
        Dim oDataFiller As New clsDataFiller(Me.DSN)
        If mDgvCount > 0 Then
            If Me.mIsPosted = False Then
                Dim retTbl As DataTable = New DataTable
    ...
    '============ ADD PTS 20151009 ===================
    Private Sub btn_RekananOther_Click(sender As Object, e As EventArgs) Handles btn_RekananOther.Click
        Dim oDataFiller As New clsDataFiller(Me.DSN)
        If mDgvCount > 0 Then
            If Me.mIsPosted = False Then
                Dim retTbl As DataTable = New DataTable
