...
Public Class dlgSearch
    ...
    Public Shadows Function OpenDialog(ByVal owner As System.Windows.Forms.IWin32Window, _
        ...
        ElseIf Me.source = "account_ca" Then
            Me.FormatDgvMstAccountCa(Me.DgvSearch)
    ...
    Private Function FormatDgvMstAccountCa(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        Dim cAcc_ca_id As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cAcc_ca_shortname As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn

        cAcc_ca_id.Name = "acc_ca_id"
        cAcc_ca_id.HeaderText = "ID"
        cAcc_ca_id.DataPropertyName = "acc_ca_id"
        cAcc_ca_id.Width = 65
        cAcc_ca_id.Visible = True
        cAcc_ca_id.ReadOnly = True

        cAcc_ca_shortname.Name = "acc_ca_shortname"
        cAcc_ca_shortname.HeaderText = "Name"
        cAcc_ca_shortname.DataPropertyName = "acc_ca_shortname"
        cAcc_ca_shortname.Width = 250
        cAcc_ca_shortname.Visible = True
        cAcc_ca_shortname.ReadOnly = True

        objDgv.Columns.Clear()
        objDgv.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() _
        {cAcc_ca_id, cAcc_ca_shortname})
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        If Me.DgvSearch.CurrentRow IsNot Nothing Then
            ...
            ElseIf Me.source = "periode" Then
                ...
                Me.CloseButtonIsPressed = True
            ElseIf Me.source = "account_ca" Then
                retObjTemp.Add(Me.DgvSearch.CurrentRow.Cells("acc_ca_id").Value, "retId")
                Me.retObj = retObjTemp
                Me.CloseButtonIsPressed = True
            End If
        Else
